...
pub fn join_cluster(sender: Sender<&'static str>, receiver: Receiver<&str>, node_id: &str, node_hostname: &str, node_listener_port: u16) {
    // loop {
    //     match receiver.recv() {
...
impl Node {
    fn new(id: &str, host: &str, listener_port: u16, mt_sender: Sender<&'static str>) -> Node {
        Node {
            id: id.to_string(),
            host: host.to_string(),
            gossip_fanout: 3,
